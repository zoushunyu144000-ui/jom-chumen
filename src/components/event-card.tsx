    ...
    return (
      ...
      >
        <img
          src={event.coverUrl}
          alt={event.title}
          className="aspect-4/5 w-full object-cover transition-transform duration-500 ease-out group-active:scale-[1.02] sm:aspect-4/3"
        />
    ...
    >
      <div className="relative overflow-hidden rounded-lg">
        <img
          src={event.coverUrl}
          alt={event.title}
          className="aspect-4/3 w-full object-cover transition-transform duration-400 ease-out group-hover:scale-[1.03]"
        />
      ...
      <div className="px-0.5 pt-2.5">
        ...
        <p className="mt-1 flex items-center gap-1 text-sm text-muted">
          ...
          <span className="truncate">
            {formatWhen(event.startsAt, event.currency)} · {event.venue}
          </span>
        </p>
